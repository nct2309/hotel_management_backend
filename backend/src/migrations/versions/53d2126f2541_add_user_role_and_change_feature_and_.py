"""add user role and change feature and badge into other tables

Revision ID: 53d2126f2541
Revises: 07d9a4449d98
Create Date: 2024-10-19 17:20:18.650366
...
def upgrade() -> None:
    ...
    op.add_column('room', sa.Column('feature_ids', sa.ARRAY(sa.Integer()), nullable=True))
    op.add_column('room', sa.Column('badge_ids', sa.ARRAY(sa.Integer()), nullable=True))
    op.create_unique_constraint("room_id_key", 'room', ['id'])
...
def downgrade() -> None:
    ...
    op.add_column('room', sa.Column('features', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True))
    op.add_column('room', sa.Column('badges', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True))
    op.drop_constraint("room_id_key", 'room', type_='unique')
