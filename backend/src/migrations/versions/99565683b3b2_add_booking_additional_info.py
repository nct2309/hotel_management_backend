"""add booking additional info

Revision ID: 99565683b3b2
Revises: 579326645dbf
Create Date: 2024-11-02 21:48:08.866736
...
def upgrade() -> None:
    ...
    op.add_column('booking', sa.Column('guest_contact_numbers', sa.String(), nullable=False))
